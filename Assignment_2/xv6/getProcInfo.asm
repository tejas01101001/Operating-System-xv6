...
_getProcInfo:     file format elf32-i386
  ...
  17:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  22:	6a 0c                	push   $0xc
  24:	e8 97 06 00 00       	call   6c0 <malloc>
  29:	89 c3                	mov    %eax,%ebx
  int pid = atoi(argv[1]);
  2b:	58                   	pop    %eax
  2c:	ff 76 04             	pushl  0x4(%esi)
  2f:	e8 2c 02 00 00       	call   260 <atoi>
  getProcInfo(pid, st);
  34:	5a                   	pop    %edx
  35:	59                   	pop    %ecx
  36:	53                   	push   %ebx
  37:	50                   	push   %eax
  38:	e8 56 03 00 00       	call   393 <getProcInfo>
	printf(1, "Parent PID: %d\nProcess Size: %d\nContext Switches %d\n", st->ppid, st->psize, st->numberContextSwitches);
  3d:	5e                   	pop    %esi
  3e:	ff 73 08             	pushl  0x8(%ebx)
  41:	ff 73 04             	pushl  0x4(%ebx)
  44:	ff 33                	pushl  (%ebx)
  46:	68 e0 07 00 00       	push   $0x7e0
  4b:	6a 01                	push   $0x1
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e4:	eb 1a                	jmp    600 <printf+0x1a0>
          s = "(null)";
 5e6:	bb 15 08 00 00       	mov    $0x815,%ebx
        while(*s != 0){
